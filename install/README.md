...
| `quadrf-demos` | Spatial RF Vision, PSD plot, NTSC decoder (`mpv`), near-field phasors, 802.11 Data Link, PhaseGaze, AR, and example sources under `/usr/share/quadrf/examples` |
