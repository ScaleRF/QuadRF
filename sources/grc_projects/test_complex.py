...
class test_complex(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "open.space testing", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("open.space testing")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "test_complex")
        ...
        self.soapy_custom_source_0.set_frequency(0, 5.6e9)
...
def main(top_block_cls=test_complex, options=None):
